      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl font-bold text-foreground">Choose Your Car in Georgia</h2>
          </div>
  ...
  return (
    <section className="py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-muted-foreground mb-8">Browse our available rental cars, from economy models to SUVs and 4x4 vehicles for any trip across Georgia.</p>
